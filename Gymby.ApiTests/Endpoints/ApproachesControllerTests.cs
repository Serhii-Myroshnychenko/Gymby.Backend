namespace Gymby.ApiTests.Endpoints
{
    ...
    {
        [Fact]
        public async Task ApproachesControllerTests_CreateUpdateDeleteApproach_ShouldBeSuccess()
        {
            // Arrange
            ...
            var responseUpdateApproachContent = await responseCreateApproach.Content.ReadAsStringAsync();
