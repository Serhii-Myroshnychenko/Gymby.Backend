...
{
    public class DeleteDiaryApproachHandlerTests
    {
        private readonly ApplicationDbContext Context;
        private readonly IMapper Mapper;
        private readonly IFileService FileService;

        public DeleteDiaryApproachHandlerTests()
        {
        ...
        [Fact]
        public async Task DeleteDiaryApproachHandler_ShouldBeSuccess()
        {
            // Arrange
            ...
            var handlerApproachDelete = new DeleteDiaryApproachHandler(Context, Mapper, FileService);
            ...
            var resultDiaryApproach = await handlerApproachCreate.Handle(new CreateDiaryApproachCommand()
            {
            ...
            // Assert
            resultDiaryApproachDelete.ShouldBeOfType<ExerciseVm>();
        }

        [Fact]
        public async Task DeleteDiaryApproachHandler_ShouldBeFail()
        {
            // Arrange
            var handlerProgram = new CreateProgramHandler(Context, Mapper);
            var handlerProgramDay = new CreateProgramDayHandler(Context, Mapper, FileService);
            ...
            {
                await handlerApproachDelete.Handle(new DeleteDiaryApproachCommand()
                {
                    UserId = ProfileContextFactory.UserBId.ToString(),
                    ApproachId = approachId
                }, CancellationToken.None);
